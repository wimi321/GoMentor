...
| 플랫폼 | 다운로드 |
| --- | --- |
| macOS Apple Silicon | [DMG](https://github.com/wimi321/GoMentor/releases/download/v0.3.1/GoMentor-0.3.1-mac-arm64.dmg) |
| macOS Intel | [DMG](https://github.com/wimi321/GoMentor/releases/download/v0.3.1/GoMentor-0.3.1-mac-x64.dmg) |
| Windows x64 portable ZIP | [ZIP](https://github.com/wimi321/GoMentor/releases/download/v0.3.1/GoMentor-0.3.1-win-x64-portable.zip) |
| Windows x64 installer | [EXE](https://github.com/wimi321/GoMentor/releases/download/v0.3.1/GoMentor-0.3.1-win-x64.exe) |
